namespace Pisces.Core.Configuration;

/// <summary>
/// GPIO pin assignments and hardware configuration.
/// Loaded from appsettings.json — no hardcoded pin numbers anywhere else.
/// Lives in Pisces.Core (rather than Pisces.Infrastructure) because both
/// Pisces.Infrastructure (ControlDaemonService) and Pisces.Hardware (EncoderBank)
/// need it, and Hardware may only reference Core.
/// </summary>
